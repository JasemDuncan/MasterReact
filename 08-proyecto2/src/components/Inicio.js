...
export const Inicio = () => {
  return (
    <div className='home'>
      ...
      <h2 className='title'>Te ayudo a crear tu sitio o aplicacion web, tener mas visibilidad y relevancia en internet. <Link to="/contacto">Contacta conmigo.</Link> </h2>
